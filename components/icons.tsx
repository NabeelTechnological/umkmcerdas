...
export const AdvisorIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7.014A8.003 8.003 0 0112 3c4.418 0 8 3.582 8 8 0 1.452-.387 2.803-1.056 3.944m-7.888 2.111A4.002 4.002 0 0112 15c1.232 0 2.368.558 3.14 1.414m-9.282-1.414A4.002 4.002 0 0012 15c-1.232 0-2.368-.558-3.14-1.414m-2.828 0a4.002 4.002 0 01-1.414-3.14M5 9c0 .524.08.984.195 1.414" />
    </svg>
);
...
export const LogoIcon = ({ className = 'w-8 h-8' }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" y="11" width="5" height="10" rx="2" />
        <rect x="10" y="7" width="5" height="14" rx="2" />
...
export const ExcelIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 17v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 11V7a4 4 0 018 0v4M5 8h14" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 13l-3 3m0 0l-3-3m3 3V3" />
  </svg>
);
...
export const InboxArrowDownIcon = ({ className = 'w-12 h-12' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const AuthIllustrationIcon = ({ className = 'w-full h-auto' }: { className?: string }) => (
    <svg className={className} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <g fill="none" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round">
            <rect x="48" y="48" width="416" height="416" rx="24" stroke="#fff" fill="#fff" fillOpacity="0.1"/>
            {/* Bar chart */}
            <path stroke="#a78bfa" d="M128 368 V 256" />
            <path stroke="#818cf8" d="M192 368 V 208" />
            <path stroke="#6366f1" d="M256 368 V 288" />
            <path stroke="#4f46e5" d="M320 368 V 176" />
            <path stroke="#c4b5fd" d="M384 368 V 304" />
            {/* Line graph */}
            <path stroke="#fff" d="M112 160 l 64 -48 l 80 64 l 96 -80 l 48 32"/>
            {/* Circles on line graph */}
            <circle cx="112" cy="160" r="8" fill="#fff"/>
            <circle cx="176" cy="112" r="8" fill="#fff"/>
            <circle cx="256" cy="176" r="8" fill="#fff"/>
            <circle cx="352" cy="96" r="8" fill="#fff"/>
            <circle cx="400"cy="128" r="8" fill="#fff"/>
             {/* Bottom axis line */}
            <path stroke="#fff" strokeOpacity="0.5" d="M96 368 H 416"/>
        </g>
    </svg>
);
...
export const UserCircleIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
      <path fillRule="evenodd" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM7.07 18.28c.43-.9 1.1-1.67 2.01-2.28.9-.61 2.04-.94 3.22-.94s2.32.33 3.22.94c.9.61 1.58 1.38 2.01 2.28-1.55.8-3.26 1.25-5.23 1.25s-3.68-.45-5.23-1.25zM12 12c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z" clipRule="evenodd" />
    </svg>
);
